...
public class Ast2Gal implements IVisitor {
	...
	@Override
	public Object build(Terminal terminal) {
	...
	public Object build(Dollar o) {
		print(o.toString());
		return null;
	}

	public Object build(Field field, Object dollar, Object field_name) {
	...
	public void enter(Mode mode) {
		indent();
		newline();
		print(String.format("* %s: ", mode.state.toString()));
	}
