...
import gal.ast.export.Ast2Dot;
import gal.ast.export.Ast2Gal;
import gal.ast.export.AutPrinter;
...
// STATE 
	...
	final public String pStateIdentifier() throws ParseException {
		String name;
		switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
		case KEY:
		case CONDITION:
...
// PARAMETERS
	final public LinkedList<Argument> pOptionalArguments() throws ParseException {
		LinkedList<Argument> arguments = new LinkedList<Argument>();
		switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
		case 26: {
			jj_consume_token(26);
	...
	final public void pArguments(LinkedList<Argument> arguments) throws ParseException {
		Argument p;
		p = pArgument();
		arguments.add(p);
		label_5: while (true) {
	...
	final public Argument pArgument() throws ParseException {
		Token token;
		Argument argument;
		int i;
		switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
...
// VARIABLE
	final public Argument pVariable() throws ParseException {
		Dollar d;
		Argument p;
		d = pDollar();
		p = pOptField(d);
	...
	final public Dollar pDollar() throws ParseException {
		int n;
	...
	final public Argument pOptField(Dollar dollar) throws ParseException {
		Token token;
		switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
		case 36: {
			jj_consume_token(36);
...
// NATURAL
	final public int pNat() throws ParseException {
		Token token;
		token = jj_consume_token(NAT);
		{
			if ("" != null)
...
// INTEGER
	final public int pInteger() throws ParseException {
		int s = 1;
		int n;
		switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
		case MINUS: {
	...
	private static void jj_la1_init_0() {
		jj_la1_0 = new int[] { 0x10006e0, 0x4000000, 0x10016e0, 0x40000000, 0x80000000, 0x4040060, 0x0, 0x2000080,
				0xc00000, 0xc00000, 0x2000080, 0x4040060, 0x600000, 0x600000, 0x60, 0x31a1600, 0x4000000, 0x0,
				0x31a1600, 0x1000400, 0x0, 0x2005900, 0x10006e0, 0x80000, };
	}

	private static void jj_la1_init_1() {
		jj_la1_1 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x8,
