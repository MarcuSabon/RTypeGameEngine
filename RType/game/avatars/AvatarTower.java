...
public class AvatarTower extends Avatar {

	public AvatarTower(View v, Entity e) {
		super(v, e);
	}
	...
	public void render(Graphics2D g) {
		...
		// For example, drawing additional information or effects related to the Tower
		// g.drawString("Tower Name: " + e.getName(), x, y - 10); // Example text
	}
	...
	private void drawTowerCell(Graphics2D g) {
		int CellWidth = v.pxPerMeter();
		...
		// create a polygon for the Tower, a triangle pointing upwards
