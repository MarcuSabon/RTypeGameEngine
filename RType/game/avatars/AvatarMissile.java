...
public class AvatarMissile extends Avatar {
	...
	public AvatarMissile(View0 v, Entity e) {
		super(v, e);
		this.v = v;
		missile = (Missile) e;
	}
	...
	public void render(Graphics2D g) {
		...
		if (!missile.collided) {
			...
			explosionframes = (v.explosion(e.x() * cellWidth, e.y() * cellWidth, explosionframes, 5, 0));
		}
//		if (laserframes > 0) {
//			if (e.orientation() == 0) {
//				laserframes = ((View0) v).laser((laserX + 1) * cellWidth, (laserY + 1) * cellWidth, laserframes, 1,
//						e.orientation() - 180); // j'ai faite un ptit oupsi et j'ai fait le sprite a l'envers
//			} else {
//				laserframes = ((View0) v).laser((laserX) * cellWidth, (laserY) * cellWidth, laserframes, 1,
//						e.orientation() - 180); // j'ai faite un ptit oupsi et j'ai fait le sprite a l'envers
//			}
//		}
	}
